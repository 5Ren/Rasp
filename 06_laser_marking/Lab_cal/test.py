...
def load_sample_txt(filepath):
    ...
    # 型を明示的に float64 に揃える（mergeエラー回避の最重要ポイント）
...
cmf_file = './color_matching_functions_interp.csv'
d65_file = './D65_distribution_interp.csv'
...
result_df.to_csv('lab_results.csv', index=False)
